    ...
    const caseStudies = [
        {
            ...
            image: "https://images.unsplash.com/photo-1621451537084-482c73073a0f?w=800&fit=crop"
        },
        {
            ...
            image: "https://images.unsplash.com/photo-1577563908411-5077b6dc7624?w=800&fit=crop"
        }
    ];
            ...
            <div className="relative bg-indigo-900">
                ...
                <div className="relative px-4 py-24 mx-auto max-w-7xl sm:py-32 sm:px-6 lg:px-8">
                    ...
                    <div className="flex mt-10 space-x-4">
                        <button
                            onClick={() => setqr(true)}
                            className="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-yellow-600 border border-transparent rounded-md hover:bg-yellow-700"
                        >
                            {t('hero.joinButton')}
                    ...
                    <div className="mt-16">
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                            <div className="p-6 rounded-lg bg-gray-50">
                                <h3 className="text-lg font-medium text-gray-900">{t('about.mission.cultural.title')}</h3>
                                <p className="mt-2 text-gray-600">
                                    {t('about.mission.cultural.description')}
                                </p>
                            </div>
                            <div className="p-6 rounded-lg bg-gray-50">
                                <h3 className="text-lg font-medium text-gray-900">{t('about.mission.leadership.title')}</h3>
                                <p className="mt-2 text-gray-600">
                                    {t('about.mission.leadership.description')}
                                </p>
                            </div>
                            <div className="p-6 rounded-lg bg-gray-50">
                                <h3 className="text-lg font-medium text-gray-900">{t('about.mission.cooperation.title')}</h3>
                                <p className="mt-2 text-gray-600">
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                        {caseStudies.map((study, index) => (
                            <div key={index} className="overflow-hidden bg-white rounded-lg shadow-sm">
                                ...
                                />
                                <div className="p-6">
                                    <h3 className="mb-2 text-xl font-semibold text-gray-900">{study.title}</h3>
                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 gap-12 mt-16 lg:grid-cols-2">
                        ...
                        <div className="space-y-6">
                            <h3 className="mb-6 text-2xl font-bold text-gray-900">{t('about.social.updates.title')}</h3>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="p-8 bg-white shadow-sm rounded-2xl">
                                <h3 className="text-2xl font-bold text-gray-900">{t('about.social.share.title')}</h3>
                            ...
                            {/* Social Links */}
                            <div className="p-8 bg-white shadow-sm rounded-2xl">
                                <h3 className="text-2xl font-bold text-gray-900">{t('about.social.follow.title')}</h3>
                                <p className="mt-2 mb-6 text-gray-500">{t('about.social.follow.subtitle')}</p>
                                <div className="space-y-4">
                                    ...
                                    >
                                        ...
                                        />
                                        <div>
                                            <p className="font-medium text-gray-900">{t('about.social.follow.instagram.name')}</p>
                                            <p className="text-sm text-gray-500">{t('about.social.follow.instagram.handle')}</p>
                                        </div>
                                    </a>
                                    <a
                                    ...
                                    >
                                        ...
                                        />
                                        <div>
                                            <p className="font-medium text-gray-900">{t('about.social.follow.facebook.name')}</p>
                                            <p className="text-sm text-gray-500">{t('about.social.follow.facebook.handle')}</p>
                                        </div>
                                    </a>
                                    <a
                                    ...
                                    >
                                        ...
                                        />
                                        <div>
                                            <p className="font-medium text-gray-900">{t('about.social.follow.linkedin.name')}</p>
                                            <p className="text-sm text-gray-500">{t('about.social.follow.linkedin.handle')}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
...
const Payment = ({ setqr }: { setqr: object }) => {
    ...
    return (
        <div className='absolute h-screen w-screen inset-0 bg-black/60 z-50 flex items-center justify-center'>
            <div className="w-full max-w-md mx-auto border-4 rounded-xl bg-white border-purple-700">
                <div className="glass rounded-2xl overflow-hidden shadow-apple">
                    ...
                    <div className="px-6 py-5">
                        <div className="flex items-center justify-between">
                            ...
                            <button className="rounded-full py-1 px-3 bg-primary/10 text-primary text-sm font-medium bg-purple-400 text-white"
                                onClick={() => { setqr(false) }}
                            >
                                Back
                            </button>
                    ...
                    {/* QR Code Section */}
                    <div className="p-2 flex flex-col items-center rounded-xl">
                        <div className="relative p-4 bg-white rounded-xl shadow-sm mb-4 border-2">
                            <img
                                src={QR}
                                alt="Payment QR Code"
                                width={200}
